...
public class BoardDto {
	...
	public BoardDto(int board_num, String board_name, String board_pass, String board_subject, String board_content,
			String board_file, int board_re_ref, int board_re_lev, int board_seq, int board_readcount,
			Date board_date) {
		super();
	...
	public BoardDto(int board_num, String board_name, String board_subject, String board_content, String board_file,
			int board_re_ref, int board_re_lev, int board_seq, int board_readcount, Date board_date) {
		super();
		this.board_num = board_num;
		this.board_name = board_name;
		this.board_subject = board_subject;
	...
	public String toString() {
		return "BoardDto [board_num=" + board_num + ", board_name=" + board_name + ", board_pass=" + board_pass
				...
				+ ", board_re_ref=" + board_re_ref + ", board_re_lev=" + board_re_lev + ", board_seq=" + board_seq
